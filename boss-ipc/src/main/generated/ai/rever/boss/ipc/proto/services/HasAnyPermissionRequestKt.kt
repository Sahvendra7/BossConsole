...
@kotlin.jvm.JvmName("-initializehasAnyPermissionRequest")
public inline fun hasAnyPermissionRequest(block: ai.rever.boss.ipc.proto.services.HasAnyPermissionRequestKt.Dsl.() -> kotlin.Unit): ai.rever.boss.ipc.proto.services.HasAnyPermissionRequest =
  ai.rever.boss.ipc.proto.services.HasAnyPermissionRequestKt.Dsl._create(ai.rever.boss.ipc.proto.services.HasAnyPermissionRequest.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `boss.ipc.v1.services.HasAnyPermissionRequest`
 */
public object HasAnyPermissionRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: ai.rever.boss.ipc.proto.services.HasAnyPermissionRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: ai.rever.boss.ipc.proto.services.HasAnyPermissionRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): ai.rever.boss.ipc.proto.services.HasAnyPermissionRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun ai.rever.boss.ipc.proto.services.HasAnyPermissionRequest.copy(block: `ai.rever.boss.ipc.proto.services`.HasAnyPermissionRequestKt.Dsl.() -> kotlin.Unit): ai.rever.boss.ipc.proto.services.HasAnyPermissionRequest =
  `ai.rever.boss.ipc.proto.services`.HasAnyPermissionRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
