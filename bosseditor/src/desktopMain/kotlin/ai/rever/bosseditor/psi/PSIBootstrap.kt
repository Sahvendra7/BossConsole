 ...
 */
object PSIBootstrap {
    private val logger = LspLogger.forComponent("PSIBootstrap")
    ...
    fun initialize() {
        ...
        try {
            ...
            rootDisposable = Disposer.newDisposable("BossEditor-PSI")
            ...
            logger.error(LogCategory.GENERAL, "Failed to initialize PSI", error = e)
            shutdown()
    ...
    fun shutdown() {
        ...
        try {
            ...
            logger.warn(LogCategory.GENERAL, "Error during shutdown", error = e)
        }
    }
    ...
    fun parseFile(file: File): KtFile? {
        ...
        val content = try {
            ...
            logger.warn(LogCategory.GENERAL, "Failed to read file", data = mapOf("file" to file.name), error = e)
            return null
        }
