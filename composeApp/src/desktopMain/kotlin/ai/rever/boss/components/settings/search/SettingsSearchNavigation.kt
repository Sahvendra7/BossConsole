 ...
 *
 * A function rather than two copies of the same `if`, because the in-window search box and the
 * external reveal both land on this decision and only the counter differs between them.
 */
