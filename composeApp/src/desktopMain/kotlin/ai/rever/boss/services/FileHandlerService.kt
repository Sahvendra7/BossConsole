...
actual object FileHandlerService {
    ...
    internal fun incrementProcessing() {
        ...
        println("FileHandlerService: incrementProcessing (count: $count, isProcessing: ${_isProcessing.value})")
    }
    ...
    internal fun decrementProcessing() {
        ...
        _isProcessing.value = (count > 0)
        println("FileHandlerService: decrementProcessing (count: $count, isProcessing: ${_isProcessing.value})")
    }
}
